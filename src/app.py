...
activities = {
    ...
    "Tennis Club": {
        "description": "Tennis instruction and matches for all skill levels",
...
def unregister_participant(activity_name: str, email: str):
    ...
    # Find participant in a case-insensitive way
    email_to_remove = email.strip().lower()
    participant = next(
        (p for p in activity["participants"] if p.lower() == email_to_remove),
        None,
    )
